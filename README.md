...
2. [Установка](#установка)  
   - 2.1 [Изменение настроек Magisk](#изменение-настроек-magisk)  
   - 2.2 [Установка модулей](#установка-модулей)  
3. [Настройка](#настройка)  
   - 3.1 [Настройка модулей](#настройка-модулей)  
   - 3.2 [Настройка приложений](#настройка-приложений)  
4. [Ограничения метода](#ограничения)  
