...
### 1.1 Изменение настроек Magisk
   ...
   - Откройте «Настройка DenyList», откройте меню (три точки в правом верхнем углу), поставьте галочку на пункт «Системные приложения». Затем выделите галочкой приложение Сервисы Google Play, нажмите на иконку этого приложения и включите все переключатели. То же самое сделайте с приложением WhatsApp и WhatsApp Business.
