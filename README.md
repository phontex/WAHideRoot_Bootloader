...
- **2.1. Настройка модулей:**
  ...
  После этого зозвращаетесь в Tricky Addon, откройте меню и выбераете «Устоновить пользовательский Keybot». Выбераете ранее извлечённый вами файл с названием «keybox.xml»
